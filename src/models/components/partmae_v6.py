...
from src.models.components.loss.pose_v3 import PoseLoss, PoseHead
...
class PARTMaskedAutoEncoderViT(nn.Module):
    ...
    def forward_pose_loss(self, proj_z, gt_dT, joint_ids_remove):

...
def vit_base(cfg="src/models/components/cl_vs_mim/simmim_pretrain__vit_base__img224__800ep.yaml",
             opts=None,
             local_rank=0,
             name="simmim_vit_b"):    
    import argparse
    from src.models.components.cl_vs_mim.simmim_config import get_config
    from src.models.components.cl_vs_mim.simmim import build_vit
